...
from export_predict_with_passages import export_predict_with_passages
from root_dir_path import ROOT_DIR
from utils import get_model, evaluate, predict, load_data, read_complete


def normalize_inference_method(inference_method):
...
def main(args):
    args.inference_method = normalize_inference_method(args.inference_method)
    ...
    for filename, fulldata in data_list:
        ...
        for test_id, data in tqdm(enumerate(fulldata), total=len(fulldata)):
            ...
            elif args.inference_method == "vanilla":
        ...
        export_predict_with_passages(predict_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--inference_method", type=str, required=True, choices=["icl", "prag", "combine", "vanilla", "vanila"])
    # LoRA
